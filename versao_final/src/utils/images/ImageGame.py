...
class ImageGame(ABC):
    def __init__(self) -> None:
        ...
        self.__images:list[Img] = [
            ...
            Img(name=img_names_constants.DEATH_PLAYER, path=f"{base_path}/player/death_player.webp", height=35, width=70),
            ...
            Img(name=img_names_constants.RUN_PLAYER, path=f"{base_path}/player/player_run.webp", height=player_constants.HEIGHT, width=player_constants.WIDTH),
